...
const BlogData = [
  {
    ...
    published: "Jan 20, 2025 by Sleepyhead",
    image: Img1,
    aosDelay: "0",
    href: "https://mysleepyhead.com/blog/find-sofa-online?srsltid=AfmBOopyJjY8w1FOXcMPH3fJp9cLbzzAeUXtowLAsZbFefSDU2uvABGO"
  },
  {
    ...
    published: "Jan 20, 2025 by HouseBeautiful",
    image: Img2,
    aosDelay: "200",
    href: "https://www.housebeautiful.com/room-decorating/bedrooms/a63092990/bedroom-design-trends-2025"
  },
  {
    ...
    published: "Jan 20, 2025 by Coohom",
    image: Img3,
    aosDelay: "400",
    href: "https://www.coohom.com/article/space-saving-furniture-for-small-spaces"
  },
];

const Blogs = () => {
  return (
    <div className="my-12 mt-[8rem] mb-[10rem]">
      <div className="mx-auto px-[1rem] sm:px-[10.2rem]">
        <Heading title="Recent News" subtitle="Explore Our Blogs" />

        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 gap-y-8 sm:gap-4 md:gap-8 ">
          {BlogData.map((data) => (
            <div data-aos="fade-up" data-aos-delay={data.aosDelay}className="bg-gray-900" key={data.title}>
              ...
              <div className="space-y-2">
                <p className="text-xs text-gray-400 mt-9">{data.published}</p>
                <p className="font-bold text-emerald-500 line-clamp-1">{data.title}</p>
                <p className="text-md text-balance text-gray-400 line-clamp-8 leading-relaxed">
                  {data.subtitle}
                </p>
              </div>
            </div>
