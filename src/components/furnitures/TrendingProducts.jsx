...
const TrendingProducts = () => {
  const trendingProducts = AllFurnitureData.map((product) => ({
    ...product,
    discountValue: parseInt(product.discount.replace("%", "")),
  }))
  ...
  return (
    <div className="mt-[5rem] mb-[5rem] bg-gray-900 py-10">
      <div className="mx-auto px-[1rem] sm:px-[10.2rem]">
        <h1 className="text-3xl font-bold leading-none tracking-tight text-center mb-12 text-white">
          Trending Products
        </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {trendingProducts.map((data) => (
            ...
            >
              ...
              <a href="/furnitures">
                <button className="mt-4 w-full bg-[#f42c37] cursor-pointer hover:scale-105 duration-300 py-2 px-8 rounded-full relative z-10">
                  View Details
                </button>
              </a>
            </div>
